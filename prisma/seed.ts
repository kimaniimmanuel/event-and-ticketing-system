...
const USERS: [string, string, string, string][] = [
  ["Demo Host", "demohost", "host@tikiti.dev", "Nairobi"],
  ["Demo Attendee", "demoattendee", "attendee@tikiti.dev", "Nairobi"],
...
const ORGS: OrgSeed[] = [
  { name: "Nairobi Tech Community", owner: "host@tikiti.dev", admins: ["cynthia@example.com"], followers: ["attendee@tikiti.dev", "brian@example.com", "esther@example.com", "james@example.com", "peter@example.com"], description: "A community hub for tech meetups, workshops, and hackathons across Nairobi." },
  { name: "UoN Student Union", owner: "cynthia@example.com", admins: ["esther@example.com"], followers: ["attendee@tikiti.dev", "brian@example.com", "david@example.com", "olivia@example.com"], description: "Events, career fairs, and student life at the University of Nairobi." },
  ...
  { name: "Nairobi Creatives", owner: "esther@example.com", admins: ["grace@example.com"], followers: ["attendee@tikiti.dev", "irene@example.com", "faisal@example.com", "mary@example.com"], description: "Music, film, art, and photography events for Nairobi creatives." },
  { name: "Kisumu Music Collective", owner: "brian@example.com", admins: ["olivia@example.com"], followers: ["grace@example.com", "attendee@tikiti.dev", "queenter@example.com"], description: "Celebrating the sounds and artists of the lake region." },
  ...
  { name: "Mombasa Foodies", owner: "faisal@example.com", admins: ["amina@example.com"], followers: ["khadija@example.com", "umar@example.com", "attendee@tikiti.dev"], description: "Food festivals and tasting events along the coast." },
  { name: "Nairobi Gamers League", owner: "james@example.com", admins: ["peter@example.com"], followers: ["leon@example.com", "nelson@example.com", "attendee@tikiti.dev"], description: "Esports tournaments and casual gaming nights in Nairobi." },
  { name: "Women in Tech Kenya", owner: "khadija@example.com", admins: ["cynthia@example.com"], followers: ["esther@example.com", "mary@example.com", "tabitha@example.com", "attendee@tikiti.dev"], description: "Empowering women in technology through events and mentorship." },
...
const EVENTS: EventSeed[] = [
  // ---- Past events ----
  { title: "Community Launch Night", description: "Our very first meetup — lightning talks, demos, and networking.", category: "Technology", format: "IN_PERSON", venue: "iHub, Nairobi", daysFromNow: -60, hour: 18, capacity: 120, visibility: "PUBLIC", host: "host@tikiti.dev", org: "Nairobi Tech Community" },
  { title: "Intro to TypeScript Workshop", description: "A hands-on evening covering TypeScript fundamentals for JavaScript developers.", category: "Technology", format: "IN_PERSON", venue: "iHub, Nairobi", daysFromNow: -50, hour: 17, capacity: 60, visibility: "PUBLIC", host: "host@tikiti.dev", org: "Nairobi Tech Community" },
  ...
  { title: "Data Science Bootcamp (Online)", description: "A one-day virtual intro to data analysis with Python and pandas.", category: "Education", format: "VIRTUAL", virtualLink: "https://meet.example.com/data-bootcamp", daysFromNow: -20, hour: 10, capacity: 200, visibility: "PUBLIC", host: "host@tikiti.dev" },
  ...
  // ---- Upcoming events ----
  { title: "Hack Night: Build with AI", description: "An evening of hacking on AI-powered apps. Bring a laptop and an idea.", category: "Technology", format: "IN_PERSON", venue: "iHub, Nairobi", daysFromNow: 4, hour: 18, capacity: 60, visibility: "PUBLIC", host: "host@tikiti.dev", org: "Nairobi Tech Community" },
...
async function main() {
  ...
  console.log("Demo login: host@tikiti.dev / password123 (or attendee@tikiti.dev)");
}
